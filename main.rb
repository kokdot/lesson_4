...
train1 = PassengerTrain.new(105)
trains[train1.number] = train1
train2 = CargoTrain.new(106)
  ...
  when 3 # "3     - Управление поездом"
    loop do
      ...
      when 3 #"3     - Действия с  поездом: "
        ...
        train = trains[number]
        if train
          puts "Это #{train.type} поезд у него #{train.vans.size} вагонов"
          loop do
            puts "Выберите пункт меню для выполнения дальнейших действий: "
